                ...
                <div> <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}><h1 className="cart">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" id="IconChangeColor" height="68" width="68">
                        <rect width="156" height="156" fill="none">
                            ...
                            <span className="cart_quantity_count">{totalItemsInCart}</span> {/* Display total items in cart */}
                            </h1></a></div>
            </div>
        </div>
        {!showCart ? (
                <div className="product-grid">
                    {plantsArray.map((category, index) => (
                        <div key={index}>
                            <div align="center"><h2 className="plant_heading">{category.category}</h2></div>
